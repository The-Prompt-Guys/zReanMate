...
import { chatKitParams, chatLanguageQuery, chatSessionParams, createChatSchema, explainChatSchema } from '../validation/chat.schemas.js';

const router = Router();
router.use(...authenticated);
router.get('/history', validateQuery(chatLanguageQuery), chatController.history);
router.post('/explain', validateBody(explainChatSchema), chatController.explain);
